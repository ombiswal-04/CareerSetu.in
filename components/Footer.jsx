                ...
                <div className="footer__grid">
                    ...
                    <div className="footer__col">
                        <ul className="footer__list">
                            <li className="footer__item"><Link href="/about" className="footer__link">About us</Link></li>
                            <li className="footer__item"><Link href="/careers" className="footer__link">Careers</Link></li>
                            <li className="footer__item"><Link href="/employer" className="footer__link">Employer home</Link></li>
                            <li className="footer__item"><Link href="/sitemap" className="footer__link">Sitemap</Link></li>
                            <li className="footer__item"><Link href="/credits" className="footer__link">Credits</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer__col">
                        <ul className="footer__list">
                            <li className="footer__item"><Link href="/help" className="footer__link">Help center</Link></li>
                    ...
                    <div className="footer__col">
                        <ul className="footer__list">
                            <li className="footer__item"><Link href="/privacy" className="footer__link">Privacy policy</Link></li>
                            <li className="footer__item"><Link href="/terms" className="footer__link">Terms & conditions</Link></li>
